...
get_header(); ?>
		...
		<div class="cards">
			<div class="card">
				<div class="card_image">
					<a href="#" class="smoothScroll"><img src="wp-content/themes/modernmural/img/category.png" alt=""></a>
				</div>
			...
			<div class="card">
				<div class="card_image">
					<a href="#difference" class="smoothScroll"><img src="wp-content/themes/modernmural/img/difference.png" alt=""></a>
				</div>
				<div class="card_content">
					<a href="#difference" class="smoothScroll"><h2>The <img src="wp-content/themes/modernmural/img/favicon.png" id="modern_mural_difference"> Difference</h2>
			...
			<div class="card">
				<div class="card_image">
					<a href="#works" class="smoothScroll"><img src="wp-content/themes/modernmural/img/works.png" alt=""></a>
				</div>
				<div class="card_content">
			...
			<div class="card">
				<div class="card_image">
					<a href="index.php" class="smoothScroll"><img src="wp-content/themes/modernmural/img/blog.png" alt=""></a>
				</div>
				<div class="card_content">
	...
	<article>
		<a href="#top">
		<img src="wp-content/themes/modernmural/img/arrow.png" alt="arrow up" class="arrowUp">
	</a>
	</article>

		<h1 class="sectionHeader" id="difference">The M<img src="wp-content/themes/modernmural/img/favicon.png" class="modern_mural_difference">dern Mural Difference</h1>

	  <aside class="aboutAside">

	    <img src="wp-content/themes/modernmural/img/jenniferjeffers.jpg" alt="headshot" title="Jennifer Jeffers" class="aboutImage">
	      <p>Hi, I'm Jennifer Jeffers, the founder and owner of The Modern Mural and its sister site, <a href="www.thesimplestencil.com" alt="the simple stencil" title="The Simple Stencil">The Simple Stencil</a>. I've always had a love affair with words and encouraging others, so it is a dream come true that since 2004, my "job" is to bring meaningful phrases and words of encouragment into my customers homes and professional spaces. It is with that spirit of bringing beauty into people's lives that I created The Modern Mural.</p>
	      <p>It also brings me joy that The Modern Mural empowers people to create their own custom artwork on their walls. It's a thrill to see what we can create together!</p>
				<p>Here at The Modern Mural, we are proud to offer you the personalized customer service that only a small business like ours could provide. You're a valuable part of our business, and we appreciate you.</p>
	  </aside>
	  ...
	  <section class="aboutSection">
	    ...
	    <h2>Learn more about The Difference <br>in The Modern Mural products.</h2>
	      <p>We use HP Latex Inks which provide not only durability and versatility, but also high-quality, odorless prints that reduce the environmental impact by using water-based inks. This innovation offers a healthier solution from the print shop all the way to your space at work or home.</p>
				...
				<img src="wp-content/themes/modernmural/img/ecologo.png" class="aboutImg">
				<img src="wp-content/themes/modernmural/img/greenguard.png" class="aboutImg">
	  </section>
	</div>

		<div class="border">
			<section class="worksSection">
				<img src="wp-content/themes/modernmural/img/office_mockup.jpg" alt="office mural" title="Office space inspiration">
	...
	<div class="border">
	  ...
	  <section class="contactSection">
	    <article class="contact">
	      <img src="wp-content/themes/modernmural/img/livechat.png" class="contactImg">
	      <h2>Live Chat</h2>
	    </article>

	    <article class="contact">
	      <img src="wp-content/themes/modernmural/img/email.png" class="contactImg">
	      <h2>Email</h2>
	        <p><a href="mailto:TheModernMural@gmail.com">TheModernMural@gmail.com</a></p>
	    </article>

	    <article class="contact">
	      <img src="wp-content/themes/modernmural/img/mail.png" class="contactImg">
	      <h2>Mail</h2>
	    ...
	    <article class="contact">
	      <img src="wp-content/themes/modernmural/img/phone.png" class="contactImg">
	        <h2>Phone</h2>
